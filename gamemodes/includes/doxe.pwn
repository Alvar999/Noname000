...
public OnFilterScriptInit()
{
        ...
        print("-----------------------------------------------------------------\n");
        CreateDynamic3DTextLabel("Noi do xe\n/doxe de do xe",0xa5bbd0FF,-1508.2338,982.9295,7.1853,50.0);
        CreateDynamic3DTextLabel("Noi do xe\n/doxe de do xe",0xa5bbd0FF,1835.3324,-1865.9030,13.3828,50.0);
...
{
        if(IsPlayerInRangeOfPoint(playerid,8,-1508.2338,982.9295,7.1853) || IsPlayerInRangeOfPoint(playerid,8,1835.3324,-1865.9030,13.3828)) {
                ...
                SendClientMessage(playerid, C_AVISO, "[Do Xe] Ban khong o noi do xe•");
        }
        return 1;
}
